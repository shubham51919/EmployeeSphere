...
import shape_show_more from "../../../Assets/hrAssets/shape-show-more.svg";
...
const PendingPanels = ({
  ...
  return (
    ...
    >
      <Flex style={{ display: "flex" }}>
        {lineImage ? (
          <Image
            src={lineGrey}
            height="90%"
            style={{ minWidth: "8px", paddingBottom: "10px" }}
          />
        ) : (
          <></>
        )}
        ...
        >
          ...
          >
            <Flex style={{ gap: "0.5rem" }}>
              <span className="hide-on-mobile" style={{ width: "1rem" }}></span>
              <Text
            ...
            <Flex vAlign="start" style={{ gap: "0.5rem" }}>
              ...
              >
                <Text
                  content={`${getTime(ticket?.createdAt)}`}
                  style={{
                    fontSize: "0.75rem",
                    fontWeight: "400",
                  }}
              ...
              >
                <Text
                  content={`${getDate(ticket?.createdAt)}`}
                  style={{
                    fontSize: "0.75rem",
                    fontWeight: "400",
                  }}
      ...
      <button className="show-more" style={{ display: "none" }}>
        <div className="btn-show">
          <p>Show More</p>
          <img src={shape_show_more} alt="show more" />
        </div>
      </button>
      {dividerVisible ? (
        <FluentUiProvider
